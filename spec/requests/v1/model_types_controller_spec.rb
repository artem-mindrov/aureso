...
RSpec.describe V1::ModelTypesController, type: :request do
  ...
  describe "authenticated" do
    ...
    let!(:auth) { { 'HTTP_X_USER_EMAIL' => auth_token.user.email, 'HTTP_X_AUTH_TOKEN' => auth_token.body } }

    describe "GET #index" do
      it "returns the list of models and their types" do
        get "/models/#{@model.slug}/model_types", nil, auth
    ...
    describe "POST #model_types_price" do
      it "returns a specific model type as JSON" do
        ...
        post "/models/#{@model.slug}/model_types_price/#{model_type.slug}", nil, auth
